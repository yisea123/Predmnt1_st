...
echo "/******************************************/"
${OpenOCD_CMD} -c "program  ./STM32F446RE-Nucleo/Debug/NUCLEO-F446RE_PredictiveMaintenance.bin exit reset 0x08004000"
echo "/******************************************/"
echo "     Dump FP-IND-PREDMNT1 + BootLoader"
echo "/******************************************/"

SizeBinBL=`ls -l ./STM32F446RE-Nucleo/Debug/NUCLEO-F446RE_PredictiveMaintenance.bin | awk '{print $6+0x4000};'`
${OpenOCD_CMD} -c "init" \
			   -c "reset halt" \
			   -c "sleep 100" \
			   -c "wait_halt 2" \
			   -c "dump_image ./STM32F446RE-Nucleo/Debug/NUCLEO-F446RE_PredictiveMaintenance_BL.bin 0x08000000 ${SizeBinBL}" \
			   -c "reset halt" \
			   -c "shutdown"
